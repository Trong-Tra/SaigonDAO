...
// Mock Token ABI (for vBTC and VNST)
...
export const TOKENS = {
  vBTC: {
    ...
    decimals: 18,
    address: getContractAddress('vBTC'),
    abi: MOCK_TOKEN_ABI,
  },
  VNST: {
    symbol: 'VNST',
    name: 'Vietnam Stablecoin',
    decimals: 18,
...
export const VAULTS = {
  vBTC_VNST: {
    name: 'vBTC-VNST Vault',
    address: getContractAddress('vBTC_VNST_Vault'),
    abi: VAULT_ABI,
    tokenA: TOKENS.vBTC,
    tokenB: TOKENS.VNST,
  },
